...
export const Home = () => {
  ...
  return (
    <section ref={sobreMiRef} className="w-full h-auto  flex flex-col md:flex-row justify-between items-center gap-20 relative mt-32 sm:mt-32 md:mt-48 lg:mt-28 xl:mt-28 2xl:mt-60">
