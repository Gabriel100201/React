...
export const IconButton = ({ socialMedia }) => {
  ...
  return (
    <button
      ...
      className="h-12 w-12 flex border-[2px] border-white/10 justify-center items-center rounded-full p-3 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg hover:scale-110"
