export const Navbar = () => {
  return (
    <div className="fixed z-50 mt-5 gap-7 px-5 opacity-90 backdrop-filter flex justify-between items-center backdrop-blur-md shadow-2xl left-1/2 transform -translate-x-1/2 h-10 bg-gradient-to-b from-gray-900 to-gray-950 rounded-full">
