  ...
  return (
    <section ref={parallax.ref} className="w-full">
      <div className="py-8 lg:py-20 px-7 md:px-12 2xl:px-48 w-full  bg-primary-500/20 backdrop-blur-sm rounded-2xl ">
        <p className="mb-8 lg:mb-16 text-center text-primary-50 font-medium sm:text-xl">¡Hola! Estoy emocionado de conectarme contigo. Si tienes alguna pregunta, propuesta o simplemente quieres charlar, no dudes en escribirme a mi correo electrónico. Estaré encantado de responderte.</p>        <form action="#" className="space-y-8" onSubmit={handleSubmit}>
          <div>
